...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            checksum: "b81d278cc882d6f83f22695e031af975ad99c710b15a23c8dd48fcc730df402a"
        ),
        .binaryTarget(
            name: "MobileIntelligence",
            url: "\(hostedPackageURL)/MobileIntelligence.xcframework.zip",
            checksum: "98bbcfcedf2bb1ae315110643b53007bcb37e5d965e10fce63d59beec081ab6a"
        ),
        .binaryTarget(
            name: "GeoComplySDK",
            url: "\(hostedPackageURL)/GeoComplySDK.xcframework.zip",
            checksum: "6c7c30c2312759fd82ef3e264e1968dcc20839cbf935f4f40b1a6e47ef180001"
        ),
        .binaryTarget(
            name: "GCSDKDomain",
            url: "\(hostedPackageURL)/GCSDKDomain.xcframework.zip",
            checksum: "4e91835bdf07a06c4d6c417c41bba70ef7872c0c2291550c1abfa128c50bb2eb"
        ),
        .binaryTarget(
            name: "GeoComplySDK291",
            url: "\(hostedPackageURL)/GeoComplySDK291.xcframework.zip",
            checksum: "efbee246b372217f036202e81011c4e7eec23d3c8450da90651fab6aa62830b7"
        )
    ]
)
